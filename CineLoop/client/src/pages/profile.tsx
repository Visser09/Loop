...
import { Edit, Star, Bookmark, Play, Calendar } from "lucide-react";
      ...
      <main className="pb-20">
        ...
        <div className="px-4 py-6">
          <div className="flex items-center space-x-4 mb-4">
            <img
              src={currentUser.profileImageUrl || "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=100&h=100&fit=crop&crop=face"}
          ...
          <div className="space-y-2">
            <h2 className="font-semibold text-cine-text">
              {currentUser.firstName && currentUser.lastName 
                ? `${currentUser.firstName} ${currentUser.lastName}`
                : currentUser.email?.split('@')[0] || 'Movie Enthusiast'
              }
            </h2>
